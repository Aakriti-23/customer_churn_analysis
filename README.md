...
The landing page. Six KPI cards give an at-a-glance health check of the customer base under the current filter selection: **Total Customers**, **Actual Churn %**, **Predicted Churn Rate %**, **Potential Revenue Saved**, **Net Value**, and **High Risk Customers**. Designed for leadership.

---

### Page 2 — Churn Analysis
![Churn Analysis](assets/dashboard_churn_analysis.png)
...
![Risk Insights](assets/dashboard_risk_insights.png)
...
![Business Impact](assets/dashboard_business_impact.png)
